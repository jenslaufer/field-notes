...
- [`landscape-of-21st-century-science.md`](landscape-of-21st-century-science.md) — David Krakauer, COMPLEXITY podcast S1:E1 (2019): why grand unified theories failed, the 21st-century schism between complexity science (understanding) and machine learning (prediction), mountains/monasteries/metropolis, risk as a vector, with a solo-builder read
...
- [`claude-prompt-commands.md`](claude-prompt-commands.md) — 14 „Claude Commands" aus einem Instagram-Reel: keine Secret Codes, sondern benannte Prompt-Bausteine — als Denkzug-Checkliste gelesen, mit Abgleich gegen die eigenen Skills/Agents
- [`nature-of-intelligence.md`](nature-of-intelligence.md) — Melanie Mitchell's 6-part COMPLEXITY season (Santa Fe Institute): each episode summarized individually — what intelligence is (suitcase word), language vs thought, LLMs as "exotic mind-like entities" that role-play, babies vs machines, construct validity in testing, Mitchell's own AI-seasons worldview — with a solo-builder read for an LLM-run business
- [`john-krakauer-brain-mind.md`](john-krakauer-brain-mind.md) — John Krakauer (neurologist, Johns Hopkins; brother of David), COMPLEXITY podcast S1:E95+E96 (2022): start neuroscience from behavior not neurons (neural correlate ≠ mechanism, "filler terms"), no privileged level of explanation (causal contrast, pick your level), the Learning Salon, and why human meaning-making is a discontinuity of *kind* not degree ("smart dumb algorithms" do 99%, curiosity-one vs curiosity-two) — with a solo-builder read on agent discipline and anthropomorphizing
