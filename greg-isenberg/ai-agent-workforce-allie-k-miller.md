...
related: "ai-agents-are-the-new-saas.md, making-money-loop-engineering.md, graph-engineering-clearly-explained.md, last-30-days-skill.md, software-is-dead-unfair-advantage.md"
---
...
2. **Matt Van Horn's `/last-30-days` skill** (public on GitHub; see
   [`last-30-days-skill.md`](last-30-days-skill.md)) — not just for news: *"startup ideas that
...
`fde-million-dollar-ai-job.md`. That matters for the freelancermap profile and CV (#130), where
