...
related: "geoffrey-west-scaling-cities.md (the sublinear/superlinear result Moses builds on, and the West-Brown-Enquist network theory she rebuilt in simulation), nature-of-intelligence.md (Melanie Mitchell — different Melanie, adjacent argument about what intelligence is), antifragility.md (explore/exploit as convexity), ../uebergreifende-konzepte.md"
---
