...
## Block 1: Der Prüfer, der nichts nachrechnen kann

Die verbreitete Bauform ist: ein Modell schreibt etwas, ein zweites Modell bewertet es,
...
- Ein Sicherheits-Benchmark, dessen Titel von zusammenarbeitenden kleinen Modellen
  handelt: Nimmt man die **deterministische Beweissammlung** weg (`grep`, `jq`, feste
...
## Block 2: Prüfen ohne Reparieren ist schlechter als gar nicht prüfen
...
## Block 3: Ein Pflichtfeld ohne Ausweg erzwingt eine Lüge
...
## Block 4: Wie man einem prüfenden Agenten die Frage stellt
...
## Block 5: Mehrere Modelle statt eines — wann das schadet
...
## Block 6: Die Schleife selbst — Budget und Anzahl
...
## Block 7: Was ein Prüfer liest, macht er kaputt
...
**im Browser ausführt** und das aufgezeichnete Verhalten bewertet, ist dagegen von Bauart
...
## Block 8: Gedächtnis — was die Papers über `state/memory/` sagen
...
### 2. Erst der deterministische Check allein, dann erst ein Modell
...
### 7. Kleinere Handgriffe, jeder für sich billig
...
**Zwei Papers haben das Gegenteil gemacht und sind deshalb die verlässlichsten der Liste.**
