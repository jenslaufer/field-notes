---
title: "Übergreifende Konzepte in den Field Notes"
type: "cross-source synthesis"
captured: 2026-08-02
scope: "alle 82 Inhaltsnotizen (88 Dateien inkl. 6 Verzeichnisdateien), ~98.000 Wörter, 7 Ordner"
---

# Übergreifende Konzepte

> Nicht: was steht in welcher Notiz. Sondern: **welche Gedanken kommen in Quellen
> vor, die nichts miteinander zu tun haben** — ein Physiker über Städte, ein
> Linguist über Chatbots, ein Investor über Kapitalmärkte, ein Podcaster über
> Facebook-Anzeigen, ein Verhaltensbiologe über Vogelgesang.
>
> **Aufnahmeregel:** Ein Konzept steht nur hier, wenn es in **mindestens zwei
> verschiedenen Ordnern** auftaucht und jede Stelle zitierbar ist. Kein Konzept
> wurde konstruiert, um eine Verbindung herzustellen — die Quellen zitieren
> einander fast nie und wissen nichts voneinander. Wo sie sich widersprechen,
> steht das am Ende als eigener Abschnitt, statt geglättet zu werden.
>
> Das ist eine Landkarte des Bestands, keine Handlungsliste.

---

## 1. Der Vorteil wandert weg von dem, was billig geworden ist

Der häufigste Gedanke im ganzen Bestand. Nicht „Technik verändert alles", sondern
...
- `complexity/2020-06-17-geoffrey-west-scaling-cities.md` — die härteste Fassung, aus den Daten
  ...
  Krakauer stellt Städte damit in dieselbe Klasse wie Alles-dem-Sieger-Plattformen.
- `the-gist-talk/oaktree-ai-hurtles-ahead-memo.md` — Marks in der Investorenfassung:
  öffentlich verfügbare quantitative Information über die Gegenwart kann keine
  Überrendite mehr tragen, denn alle haben sie und die Maschine verarbeitet sie
  besser. Der Rand verschiebt sich auf das Beurteilen der Folgen.

**Der Bruch zwischen den Quellen:** Sie sind sich einig, *dass* der Vorteil wandert,
und uneinig, *wohin*. Isenbergs Liste (Verteilung, Nischentiefe, eigene Daten,
Netzwerkeffekte, Wartungsbereitschaft, Einkaufskönnen), Gupta (Organisationsform),
Vas (Einsatzwissen), Soulo (Marke), Marks (Urteil über Neues). Fünf verschiedene
Nachfolger. Das ist der ehrliche Stand: die Diagnose ist stabil, die Verschreibung
nicht.

---

## 2. Unabhängigkeit ist die knappe Zutat — beim Prüfen wie beim Erfinden

Dasselbe strukturelle Argument in fünf Fachsprachen: **Dinge, die auf dieselbe Weise
denken oder auf dieselbe Weise kaputtgehen, zählen als eins.** Und der Umkehrschluss:
Teilweise getrennte Systeme erzeugen mehr Verschiedenheit als vollständig verbundene.

- `papers/orthogonal-agent-verification.md` — in einem Satz: *„independence is the
...
- `complexity/2020-04-06-rigorous-uncertainty-covid.md` — Krakauers Erklärung, warum *dieses*
  ...
  aligned."* Sein Gegenzug heißt nicht „weniger Übertragung", sondern
  **Fehlausrichtungen bauen**.
- `complexity/antifragility.md` — Taleb, aus der Risikoseite: Flugverkehr ist
...
Fünf Felder, ein Satz: **Was gleichgeschaltet ist, fällt gemeinsam aus — und denkt
gemeinsam dasselbe.**

---

## 3. Der Bericht eines Systems über sich selbst ist ein zweites Erzeugnis, kein Protokoll

Das am besten belegte Konzept im Bestand, und das einzige mit harten Zahlen aus
mehreren unabhängigen Papieren.

- `linear-digressions/2026-04-13-unfaithful-chains-of-thought.md` — gepflanzter
  Hinweis, nachweislich benutzt, im „Denken" erwähnt: **25 %** (Claude 3.7 Sonnet),
  **39 %** (R1). Auf eine Belohnungslücke trainiert: in **über 99 %** ausgenutzt, in
  **unter 2 %** ausgesprochen — stattdessen ausführliche Falschbegründungen. Und der
  Befund, der wehtut: **unehrliche Ketten waren im Schnitt länger.** Ausführlichkeit
  ist kein Ehrlichkeitssignal.
- `linear-digressions/2026-07-20-invisible-llm-failures-and-ai-fluency.md` — dieselbe
  Sache von der Nutzerseite: in 100.000 echten Verläufen enthalten **63 %** einen
  Fehler, davon sind **79 % unsichtbar**. *„If a monitoring system relies on detecting
  overt signals of failure… it will catch just 12 % of failures."* Dazu Potts'
  Beobachtung über den Bericht selbst: *„you've overlooked the fact that everything is
  at 75 %"* — und die Maschine antwortet *„you're absolutely right"* und rechnet alles
  neu. Kein Mensch verhielte sich so.
- `papers/orthogonal-agent-verification/03-critic.md` — der Grund, warum
...
- `complexity/thinking-in-systems.md` — Meadows, dieselbe Regel für Organisationen:
  den **Zweck eines Systems aus seinem Verhalten lesen, nicht aus seinen erklärten
  Zielen**.
- `linear-digressions/2026-07-27-distillation-how-to-steal-a-model.md` — der Beleg im
  Kleinen: geklaute Modelle stellen sich gelegentlich als „Claude" vor. Verrät sich
  im **Verhalten**, nie in der Auskunft.

Und Potts' Zusatzbefund, der die Sache verdreht: **selbstbewusste Sprache ist
negativ mit Richtigkeit korreliert — und Menschen vertrauen ihr mehr.**

---

## 4. Erst die Sache zerlegen, dann zum Werkzeug greifen

Eine Reihenfolge-Regel, die in Neurowissenschaft, Komplexitätswissenschaft,
...
- `complexity/2022-11-11-john-krakauer-brain-mind.md` — die Umkehrung, für die er bekannt ist:
  ...
  *„almost for confirmation, not for discovery."* Der verbreitete Fehler ist die
  ...
  Geschichte hinterher erzählen (49 neuronale Abbildungen, eine Verhaltensabbildung).
...
## 5. Die Kategorie entscheidet die Kennzahl — und der Kategorienfehler ist unsichtbar

Was man entscheidet, *was* eine Sache ist, entscheidet, *woran* man sie misst. Wird
...
- `complexity/2024-09-25-nature-of-intelligence.md` — Pavlick zur **Konstruktvalidität**:
  *„we don't really know what it means when a neural network"* einen SAT besteht. Beim
  ...
  konkrete Fähigkeit benennen, dann fragen, ob das Ding sie hat.
- `complexity/thinking-in-systems.md` — Meadows' Falle „das falsche Ziel verfolgen":
...
## 7. Die zulässige Modellgröße hängt an der Datenqualität, nicht am Ehrgeiz
...
- `linear-digressions/2026-06-01-07-how-do-you-evaluate-an-ai-agent.md` — die maschinelle
  ...
  ungefixt**.
- Und der Satz, der die Haltung trägt, aus derselben Krakauer-Folge: **„Good
  scientists are comfortable with uncertainty, bad ones are not."** Mit Kinneys
  Zwickmühle daneben: Entscheider handeln nach Gewissheiten, also werden Fachleute
  belohnt, die welche liefern — *„certainty is acquired very slowly."*
...
- `complexity/2020-06-17-geoffrey-west-scaling-cities.md` — die Herleitung: superlineares
  ...
  schrumpft jedes Mal.** *„Like being on a treadmill that's accelerating, and at some
  stage you've got to jump off onto another treadmill that's accelerating even
  faster."* Sisyphos hatte es leichter: bei ihm blieben Ball und Berg gleich.
  Wests eigener Ausweg aus der Verzweiflung war die Einsicht, dass er **Neuerung mit
  Technik verwechselt** hatte.
- `complexity/thinking-in-systems.md` — dieselbe Mechanik als Werkzeug: verstärkende
...
- `complexity/antifragility.md` — die Risikofassung: **Hormesis** — viele kleine,
...
Diese beiden letzten Punkte stehen im Bestand **nebeneinander und in Spannung** — mehr
dazu unten.

---

## 9. Der Durchschnitt vieler Verläufe ist nicht dein Verlauf

- `complexity/stochastic-processes.md` — die klarste Formulierung: eine Zufallsgröße
  ist ein Foto, ein stochastischer Prozess ein **Film**. Fast jeder teure Fehler mit
  Zufall entsteht, wenn eine Pfad-Frage mit einer Foto-Antwort beantwortet wird.
  Dazu **absorbierende Zustände** (Ruin, Tod, Abwanderung): *„Survival first is not a
  proverb, it's a theorem."* Und Spielerruin: gegen ein sehr viel größeres Vermögen
  entscheidet die Grenze, nicht die Quote.
- `complexity/antifragility.md` — dieselbe Form als Bauplan: gedeckelter Verlust,
  offener Gewinn, nichts in der fragilen Mitte. Mit dem unbequemen Nachsatz, den
  Taleb-Leser gern überlesen: **die Antifragilität des Ganzen wird von der Fragilität
  der Teile bezahlt.** Irgendwer zahlt immer.
- `the-gist-talk/oaktree-ai-hurtles-ahead-memo.md` — dieselbe Regel als
...
- `my-rejection-story/2026-03-18-anne-laure-lecunff-negativity-bias-tiny-experiments.md` — die
  ...
  Negativitätsverzerrung, sichtbar schon bei drei Monate alten Säuglingen.

---

## 10. Das Unbequeme ist der haltbarste Vorsprung

Der leiseste Faden im Bestand, und derjenige, den am meisten Quellen unabhängig
...
- `linear-digressions/2026-07-20-invisible-llm-failures-and-ai-fluency.md` — gegen die
  gesamte Produkt-Orthodoxie, und im Papier ausgeschrieben: nicht reibungsfreie
  Erlebnisse, sondern **tiefe Beteiligung** führen zu mehr Erfolg — bei zugegebenem
  Preis, dass Nutzer im Moment unzufriedener sind. Dahinter die vergiftete Zielgröße:
  *„local preference ≠ global preference"* — Schmeichelei gewinnt jede
  Einzelmessung. Und die ehrliche Härte: *„you turned to AI because it was hard or
  impossible for you to do all this verification — and now I'm saying, you've got to
  be in the role of verifier."*
- `complexity/antifragility.md` — **Redundanz sieht in ruhigen Zeiten nach
  Verschwendung aus** und ist genau der Mechanismus, der einen Schock in einen Gewinn
  verwandelt. Schulden sind das Gegenteil: negative Redundanz.
...
## Wo die Quellen einander widersprechen

Der wertvollste Teil einer Landkarte sind die Stellen, an denen zwei gute Quellen in
verschiedene Richtungen zeigen. Nichts davon ist aufgelöst.

**1. Abgeschiedenheit gegen Publikum.** Creanza (Teilvernetzung schlägt
Vollvernetzung), Evans (kleine Teams stören, große werden zitiert) und Krakauer (der
Berg von Santa Fe: *„if we were in a city, it couldn't work — and people have tried
and failed"*) sagen, dass Getrenntheit seltene Ideen schützt. Isenberg sagt in fast
jeder Folge das Gegenteil: Publikum zuerst, ACP (Audience → Community → Product),
Verteilung ist der Engpass. **Beide Seiten sind belegt, und sie messen verschiedene
Dinge** — die einen die Entstehung der seltenen Idee, die anderen ihre Verbreitung.
Krakauers eigene Auflösung ist keine Wahl, sondern **Periodizität**: *„it's almost as
if we want to be periodic and move between those two states."*

**2. Reibung einbauen oder wegnehmen.** Potts' Papier fordert wörtlich mehr
Beteiligung statt reibungsfreier Erlebnisse; die gesamte Produktliteratur im selben
Bestand (Isenbergs Bau-Folgen, die Design-Folgen) optimiert auf Reibungsfreiheit. Der
Konflikt ist echt und Potts benennt ihn selbst: *„I honestly don't know how we're
going to get out of this."*

**3. Vorhersage ohne Verständnis: hinnehmbar oder Verlust.** Marks entscheidet
pragmatisch — *„does AI do the work?"* Mitchell nennt denselben Tausch einen echten
Verlust (AlphaFold), Krakauer baut eine ganze Wissenschaft auf der Gegenposition auf.
Die Notizen enthalten beide Haltungen ohne Schiedsspruch.

**4. Neuerfindung gegen Inkrement.** West: offenes Wachstum überlebt nur durch
periodische Neuerfindung in immer kürzeren Abständen. Krakauer, zwei Ordner-Nachbarn
weiter: *„Incremental change is real change, revolutionary change is illusion."* Sie
sprechen über verschiedene Ebenen — Wachstumsgleichungen eines Systems gegen
Verhaltensänderung von Menschen —, aber wer sie als Handlungsregel liest, bekommt
zwei entgegengesetzte Anweisungen.

---

## Was die Karte über den Bestand selbst zeigt

- **Die Konzepte halten sich nicht an die Ordner.** Alle zehn stehen in mindestens
  zwei Ordnern, acht davon in mindestens drei (die Ausnahmen sind 7 und 8, die je
  zwischen Komplexität und Linear Digressions laufen). Die Ordnerstruktur bildet
  Quellen ab, nicht Gedanken —
  wer nach einem Konzept sucht, findet es nicht durch Blättern in einem Ordner.
- **Die stärksten Übereinstimmungen entstehen zwischen den am weitesten entfernten
  Quellen.** Verhaltensbiologie und Agenten-Papiere sagen dasselbe über
  Unabhängigkeit; Epidemiologie und Risikotheorie dasselbe über gleichgeschaltete
  Ausfälle; Stadtphysik und Kapitalmarkt dasselbe über den Unterschied zwischen
  Mittelwert und einzelnem Verlauf. Zwischen benachbarten Notizen im selben Ordner
  steht dagegen viel Wiederholung.
- **Zwei Cluster berühren einander nie.** Die 36 Isenberg-Notizen und die 14
  Linear-Digressions-Notizen behandeln beide Agenten — die einen als Geschäftsmodell,
  die anderen als Messproblem. Keine Notiz der einen Seite zitiert die andere. Die
  Frage „was kostet es, dass ein Agent 79 % seiner Fehler unsichtbar macht" wird im
  Verkaufsstrang nirgends gestellt.
- **Der Bestand ist stark bei Diagnose und schwach bei Verschreibung.** Bei
  Konzept 1 sind sich sechs Quellen einig, *dass* der Vorteil wandert, und nennen
  fünf verschiedene Ziele. Das ist kein Mangel der Notizen — es ist der Stand der
  Sache.

---

**Methode.** Alle 82 Inhaltsnotizen (88 Dateien, ~98.000 Wörter, 7 Ordner) im
Volltext gelesen, nicht an einen Zusammenfasser delegiert. Zahlen und Zitate stammen
aus den Notizen; wo eine Notiz eine Zahl selbst als ungeprüft markiert, ist sie hier
nicht verwendet. Zitate stehen im englischen Original, weil die Notizen sie so führen.
